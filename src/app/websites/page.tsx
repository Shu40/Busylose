...
export const metadata: Metadata = {
  title: "Website Code",
  description: "Explore website templates and source code on BusyLoss.",
};
...
export default async function WebsitesPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  const query = q || "";
  const filter: any = { category: "Website" };
  if (query) {
    filter.$or = [
  ...
  return (
    <div className="p-6 space-y-6">
      <CategoryHeader 
        title="Web Projects"
        description="High-end website templates, scripts and full-stack source code for developers."
        iconName="Globe"
        color="indigo"
